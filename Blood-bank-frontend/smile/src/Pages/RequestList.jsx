...
const RequestList = () => {
    ...
    const rejectRequest = async (id, sl) => {
        ...
        Swal.fire({
            ...
            if(res.isConfirmed){
                try {
                    const res = await axios.get(`http://192.168.29.55/api/v1/adminUser/reject_request/${id}`)
                    console.log(res)
                    Swal.fire({
    ...
    const acceptRequest = async (id) =>{
        console.log(id)
        try {
            const res = await axios.get(`http://192.168.29.55/api/v1/adminUser/confirm_recipient_donation/${id}`)
            console.log(res)
    ...
    const getTableData = async () =>{
        setLoadingPage(true)
        try{
            const res = await axios.get('http://192.168.29.55/api/v1/adminUser/get_recipient_list/')
            console.log(res)
    ...
    const viewPrevDonation = async (id) => {
        ...
        console.log(id)
        try{
            const data = await axios.get(`http://192.168.29.55/api/v1/adminUser/getFirstDon/${id}`)
