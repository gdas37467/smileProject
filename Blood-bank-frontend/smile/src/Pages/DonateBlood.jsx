...
// OTP Value
    ...
    const sendOtp = async () =>{
        ...
        if(donorInfo.firstName === '' || donorInfo.lastName === '' || donorInfo.dob === '' || donorInfo.email === '' || donorInfo.phoneNumber === '' || donorInfo.address === '' || donorInfo.bloodGroup === ''){
            ...
            timer()
            try{
                const res =  await axios.post('http://192.168.1.11:8000/api/v1/donor/send_otp/', JSON.stringify({email : donorInfo.email}))
    ...
    const verifyOtp = async () =>{
        ...
        try {
            ...
            const res = await axios.post('http://192.168.1.11:8000/api/v1/donor/register/',JSON.stringify(donorDet),{
