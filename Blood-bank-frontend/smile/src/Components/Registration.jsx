...
const Registration = (props) => {
    ...
    const addRecipient =async () => {
        ...
        try { 
            ...
            const res = await axios.post('http://192.168.29.55/api/v1/adminUser/admin_booking/', formData,{
    ...
    const addDonor = async () => {
        ...
        try {
            var token = getCookie('csrftoken')
            const res = await axios.post('http://192.168.29.55/api/v1/adminUser/admin_donor_registration/', JSON.stringify(payload),{
                headers : {'X-CSRFToken': token}
            })
            console.log(res)
            Swal.fire({
    ...
    const getCount = async () => {
        try{
            const res = await axios.get('http://192.168.29.55/api/v1/adminUser/get_total_cquantity/');
            console.log(res)
