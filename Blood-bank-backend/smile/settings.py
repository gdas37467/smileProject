...
ALLOWED_HOSTS = ['smileorganization.in' , 'www.smileorganization.in', '91.108.105.42','127.0.0.1','192.168.29.55','192.168.1.11']
...
CSRF_TRUSTED_ORIGINS = ['http://127.0.0.1:3000','http://localhost:3000' , 
                        'http://192.168.1.12:3000',"http://192.168.29.55:3000",'http://192.168.29.55','http://192.168.1.11',
...
#cron job
CRONJOBS = [
    ('*/2 * * * *', 'smile.cronjob.updateUnits', '>> ' + os.path.join(BASE_DIR,'log/debug7.log' + ' 2>&1 ')),
